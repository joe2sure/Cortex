      ...
      switch (result.status) {
        case AuthorizationStatus.authorized:
          ...
          if (result.credential != null &&
            ...
            currentUser.updateDisplayName('$firstName $lastName');
          } else {
            //
          }

          if (firstName.validate().isEmpty && lastName.validate().isEmpty) {
            if (currentUser.email.validate().isNotEmpty) {
  ...
  static Future<void> deleteFirebaseUser() async {
    ...
    if (currentUser != null) {
      try {
        ...
        throw 'Error deleting user from Firebase Authentication: $e';
      }
    } else {
